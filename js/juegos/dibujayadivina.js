...
const PALABRAS_DIBUJAR = [
    'casa','sol','corazón','gato','pizza','árbol','luna','flor','estrella','pez',
    'auto','barco','avión','nube','montaña','café','helado','libro','reloj','llave',
    'guitarra','sombrero','paraguas','bicicleta','robot','fantasma','globo','regalo','vela','anillo'
];
