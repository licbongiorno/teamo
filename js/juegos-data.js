...
window.JUEGOS = [
    ...
    // ---- COOPERATIVOS ----
    { id:'letras',     nombre:'Letras Compartidas',    icono:'🪶', categoria:'cooperativosvivo', disponible:true,  descripcion:'Cadáver exquisito: escriben una historia de a turnos, cada uno con su color.' },
    { id:'jardin',     nombre:'El Jardín Compartido',  icono:'🌱', categoria:'cuidado', disponible:true,  descripcion:'Riéguenlo y cuídenlo entre los dos para verlo florecer.' },
    { id:'ruleta',     nombre:'Ruleta de Citas',       icono:'🎡', categoria:'cooperativosvivo', disponible:true,  descripcion:'Giren juntos y dejen que el azar elija el plan de hoy.' },
    { id:'mascota',    nombre:'Mascota Virtual',       icono:'🐱', categoria:'cuidado', disponible:true, descripcion:'Cuiden a Chokurei entre los dos: comida, juego y mimos.' },
    { id:'arbol',      nombre:'Nuestro Árbol',         icono:'🌳', categoria:'cuidado', disponible:true, descripcion:'Cada gesto lindo lo hace crecer, de semilla a árbol florecido.' },
    { id:'refugio',    nombre:'El Refugio',            icono:'🏡', categoria:'cuidado', disponible:true, descripcion:'Diseñen juntos un patio virtual con lo que van ganando.' },
    { id:'puntoencuentro', nombre:'Punto de Encuentro', icono:'📍', categoria:'cuidado', disponible:true, descripcion:'La línea de tiempo viva de todo lo que construyeron acá.' },
    { id:'dibujayadivina', nombre:'Dibuja y Adivina',  icono:'🎨', categoria:'cooperativosvivo', disponible:true, descripcion:'Uno dibuja con el dedo, el otro adivina la palabra.' },
    { id:'cartas',     nombre:'Carta para abrir después', icono:'💌', categoria:'cuidado', disponible:true, descripcion:'Escribí una carta que se abre recién en la fecha que elijas.' },
    { id:'capsula',    nombre:'Cápsula del Tiempo',    icono:'📦', categoria:'cuidado', disponible:true, descripcion:'Vayan agregando notas y predicciones a una cápsula que se abre sola en la fecha que elijan.' },
    { id:'mapa',       nombre:'Mapa de Nuestros Lugares', icono:'🗺️', categoria:'cuidado', disponible:true, descripcion:'Guarden lugares importantes: recuerdos, lugares para visitar y sitios clave.' },
    { id:'escaperoom', nombre:'Escape Room Virtual',   icono:'🔓', categoria:'cooperativosvivo', disponible:true, descripcion:'3 etapas de acertijos para resolver juntos y "escapar".' },
    ...
    { id:'sudoku',     nombre:'Sudoku de a Dos',       icono:'🧩', categoria:'cooperativosvivo', disponible:true, descripcion:'Sudoku colaborativo: los dos completan celdas a la vez, sin esperar turnos.' },
    ...
    { id:'cocodrilos', nombre:'Martillo de Cocodrilos', icono:'🐊', categoria:'cooperativosvivo', disponible:true, descripcion:'Cooperativo en vivo: los dos martillan el mismo tablero. ¿Llegan a la meta juntos?' },
    { id:'pesca',      nombre:'Pesca Cooperativa',     icono:'🎣', categoria:'cooperativosvivo', disponible:true, descripcion:'Cooperativo en vivo: entre los dos, pesquen los peces que cruzan la pantalla.' },
    { id:'ladrillos',  nombre:'Rompe Ladrillos a Dúo', icono:'🧱', categoria:'cooperativosvivo', disponible:true, descripcion:'Cooperativo: una pared compartida, ¿cuánto tardan los dos en dejarla limpia?' },
];
