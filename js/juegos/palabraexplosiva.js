...
const CATEGORIAS_PALABRA_EXPLOSIVA = [
    "Animales", "Comidas", "Países", "Colores", "Objetos de casa", "Profesiones", "Frutas", "Ropa",
    "Deportes", "Películas", "Instrumentos musicales", "Ciudades", "Marcas", "Nombres propios",
    "Verbos", "Cosas de la playa", "Herramientas", "Bebidas", "Series", "Emociones",
];
