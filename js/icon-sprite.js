...
(function () {
    var SPRITE = '' +
        ...
        '<symbol id="icono-semaforo" viewBox="0 0 24 24"><rect x="8" y="2.5" width="8" height="16" rx="3"/><circle cx="12" cy="6.3" r="1.5" fill="currentColor" stroke="none"/><circle cx="12" cy="10.5" r="1.5"/><circle cx="12" cy="14.7" r="1.5"/><path d="M12 18.5v3M9 21.5h6"/></symbol>' +
        '<symbol id="icono-microfono" viewBox="0 0 24 24"><rect x="9" y="2.5" width="6" height="11.5" rx="3"/><path d="M5.5 11.5a6.5 6.5 0 0 0 13 0"/><path d="M12 18v3.5M8.5 21.5h7"/></symbol>' +
        '<symbol id="icono-whatsapp" viewBox="0 0 24 24"><path d="M12 3.5a8.3 8.3 0 0 0-7.1 12.5L3.7 20.3l4.5-1.2A8.3 8.3 0 1 0 12 3.5Z"/><path d="M8.7 8.2c.2-.5.5-.5.7-.5h.5c.2 0 .3 0 .5.4.2.4.6 1.5.6 1.6.1.1.1.3 0 .4l-.3.4-.3.4c-.1.2-.2.3 0 .5.2.3.7 1.1 1.5 1.8 1 .9 1.8 1.1 2.1 1.3.2.1.4.1.5-.1l.5-.6c.1-.2.3-.2.5-.1l1.3.6c.2.1.3.2.3.4 0 .1 0 .8-.3 1.1-.3.4-1.1.7-1.5.7-.4.1-.9.1-2.8-.6-2.3-.9-3.8-3.2-4-3.4-.1-.1-.9-1.2-.9-2.4 0-1.1.6-1.7.8-1.9Z" fill="currentColor" stroke="none"/></symbol>' +
        '<symbol id="icono-zumbido" viewBox="0 0 24 24"><rect x="8" y="3" width="8" height="18" rx="2"/><path d="M12 16.2h.01"/><path d="M4.2 7.5 2.5 6M4.2 16.5 2.5 18M19.8 7.5 21.5 6M19.8 16.5 21.5 18"/></symbol>' +
        '<symbol id="icono-risa" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9.3"/><path d="M6.5 9.5c.6-1 1.6-1 2.2 0M15.3 9.5c.6-1 1.6-1 2.2 0"/><path d="M6.7 13.2c1 2.6 3 3.9 5.3 3.9s4.3-1.3 5.3-3.9c.2-.5-.2-1-.7-1H7.4c-.5 0-.9.5-.7 1Z" fill="currentColor" stroke="none"/></symbol>' +
        '<symbol id="icono-barometro" viewBox="0 0 24 24"><path d="M4 15a8 8 0 0 1 16 0"/><path d="M12 15 16 9.5"/><circle cx="12" cy="15" r="1.4" fill="currentColor" stroke="none"/><path d="M3 19h18"/></symbol>' +
